...
const sidebarLinks = [
    ...
    { href: "/admin/requests", label: "Pending Approvals", icon: ClipboardCheck },
        ...
        <div className="min-h-screen bg-muted/30 flex">
            ...
            <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-72 bg-white border-r border-border flex-col py-8 px-5 z-40 shadow-sm">
                <div className="flex items-center gap-3 mb-10 px-2">
                    <div className="w-12 h-12 rounded-full bg-brand-blue flex items-center justify-center text-white font-bold text-sm shadow-md">
                        CUI
                    </div>
                            ...
                            <Link
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl text-[15px] font-medium transition-all duration-200 ${
                                    isActive
                                        ...
                                        : "text-slate-500 hover:bg-slate-50 hover:text-slate-900 line-through-none"
                                }`}
                            >
                                <link.icon size={20} className={isActive ? "text-brand-blue" : "text-slate-400"} />
                                {link.label}
                            </Link>
                        );
                    })}
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-border h-16 px-4 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-8 h-8 rounded-full bg-brand-blue flex items-center justify-center text-white font-bold text-[10px]">
                        CUI
                    </div>
                </div>
                <Button
